define([
  ...
  'use strict';
  class HistoryPaginationChain extends ActionChain {
    async run(context, params) {
      const { $page } = context;
      var direction = params.direction || 'first';
      var data = $page.variables.historyData || [];
      ...
      $page.variables.paginatedHistory = data.slice(startIdx, endIdx);
    }
  }
  return HistoryPaginationChain;
});